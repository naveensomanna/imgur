...
export default class Account extends React.Component {
    ...
    render() {
        ...
        return (
            <div id="avatar">
                <a href="" onClick={this.handleClick} style={{display: 'block', position: 'relative'}}><img
                    className="account_img" src={this.state.account.avatar} alt=" "/></a>
